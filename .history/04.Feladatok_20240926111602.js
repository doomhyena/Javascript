...
A függvény vizsgálja meg, hogy az adott lista összes eleme egyezik-e típusra és tartalomra

Pl.:

azonso(["abc", "abc", "abc", "abc"]) --> true
azonso(["&&", "&", "&&&", "&&&"]) --> false
azonso([true, "true"]) --> false
